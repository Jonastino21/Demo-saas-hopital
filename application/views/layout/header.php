    ...
    <div class="topaleart">
        <div class="slidealert">
            <div class="alert alert-dismissible topaleart-inside">
                <p class="palert">Alert! You are using unregistered version of Saas Salamada. Please <a href="#"
                        class="purchasemodal">click here</a> to register your purchase code for Saas Salamada.</p>
            </div>
        </div>
    </div>
    <?php
...
?>
    <div class="wrapper">
        <header class="main-header" id="alert">
            <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">
                <span class="logo-mini"><img width="31" height="19" src="<?php echo $mini_logo.img_time(); ?>"
                        alt="<?php echo $this->customlib->getAppName() ?>" /></span>
                <span class="logo-lg"><img src="<?php echo $logo_image.img_time(); ?>"
                        alt="<?php echo $this->customlib->getAppName() ?>" /></span>
            </a>
    ...
    ?>
                            <div class="langdiv" data-placement="bottom" data-toggle="tooltip"
                                title="<?php echo $this->lang->line('language') ?>"><select class="languageselectpicker"
                            ...
                            <ul class="nav navbar-nav headertopmenu">
                                ...
                                <li class="cal15">
                                    ...
                                    <a data-placement="bottom" data-toggle="tooltip"
                                        data-original-title="<?php echo $this->lang->line('notifications'); ?>"
                                        href="<?php echo base_url() . "admin/systemnotification" ?>">
                                ...
                                <li class="">
                                    <a data-target="modal" data-placement="bottom" data-toggle="tooltip" href="#"
                                        id='beddata'
                                        data-original-title="<?php echo $this->lang->line('bed_status'); ?>"
    ...
    if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_view')) {
        ?>
                                <li class="cal15"><a href="<?php echo base_url() ?>admin/calendar/events"
                                        ...
                                        data-original-title="<?php echo $this->lang->line('calendar') ?>"><i
...
?>
                                <li class="dropdown user-menu">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                                        <img src="<?php echo base_url() . $file.img_time(); ?>" class="topuser-image"
                                            alt="User Image">
                                    </a>
                                        ...
                                        <li>
                                            <div class="sstopuser">
                                                <div class="ssuserleft">
                                                    <a href="<?php echo base_url() . "admin/staff/profile/" . $id ?>"><img
